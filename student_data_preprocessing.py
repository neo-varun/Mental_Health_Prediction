...
class DataTransformationConfig:
    preprocessor_obj_file_path = os.path.join('artifacts', 'student_preprocessor.pkl')
...
class DataTransformation:
    ...
    def initialize_data_transformation(self, train_path, test_path):
        ...
        logging.info(f"Initial training data shape: {train_df.shape}")
        logging.info(f"Initial training data columns: {list(train_df.columns)}")
        ...
        logging.info(f"Training data columns after cleaning: {list(train_df.columns)}")
        ...
        # Log final data shape before transformation
        logging.info(f"Final training data shape before transformation: {input_feature_train_df.shape}")
        logging.info(f"Final test data shape before transformation: {input_feature_test_df.shape}")
    ...
    def load_and_preprocess(self, data_path):
        ...
        # Load preprocessor
        preprocessor_path = os.path.join('artifacts', 'student_preprocessor.pkl')
